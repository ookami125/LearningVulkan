	...
	uint32_t width, uint32_t height, uint32_t layerCount)
{
	...
	if (usage & VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT)
		SetImageLayout(image, aspectMask, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, NULL, cmdBuffer,
			device, true);
	else
		SetImageLayout(image, aspectMask, VK_IMAGE_LAYOUT_UNDEFINED, imageLayout, NULL, cmdBuffer, device, true);
